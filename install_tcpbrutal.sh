...
SCRIPT_INITIATOR_URL="https://github.com/PhoenixxZ2023/tcpbrutal2024/master/install_tcpbrutal.sh"
SCRIPT_INITIATOR_COMMAND="bash <(wget -qO- $SCRIPT_INITIATOR_URL)"

# URL of GitHub
REPO_URL="https://github.com/PhoenixxZ2023/tcpbrutal2024"
